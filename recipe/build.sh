...
install -m 644 "${RECIPE_DIR}/scripts/activate.csh" "${PREFIX}/etc/conda/activate.d/${PKG_NAME}_activate.csh"
install -m 644 "${RECIPE_DIR}/scripts/deactivate.csh" "${PREFIX}/etc/conda/deactivate.d/${PKG_NAME}_deactivate.csh"
install -m 644 "${RECIPE_DIR}/scripts/activate.ps1" "${PREFIX}/etc/conda/activate.d/${PKG_NAME}_activate.ps1"
install -m 644 "${RECIPE_DIR}/scripts/deactivate.ps1" "${PREFIX}/etc/conda/deactivate.d/${PKG_NAME}_deactivate.ps1"
install -m 644 "${RECIPE_DIR}/scripts/activate.xsh" "${PREFIX}/etc/conda/activate.d/${PKG_NAME}_activate.xsh"
install -m 644 "${RECIPE_DIR}/scripts/deactivate.xsh" "${PREFIX}/etc/conda/deactivate.d/${PKG_NAME}_deactivate.xsh"
