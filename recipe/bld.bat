...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
    ...
    "-replace 'find_package\\(Python3 REQUIRED COMPONENTS Interpreter Development\\)', 'find_package(Python3 REQUIRED COMPONENTS Interpreter Development)`nif (WIN32 AND MSVC)`n  set(Python3_LIBRARY_DEBUG   \"${CMAKE_INSTALL_PREFIX}/Library/libs/python3.13.lib\" CACHE FILEPATH \"\" FORCE)`n  set(Python3_LIBRARY_RELEASE \"${CMAKE_INSTALL_PREFIX}/Library/libs/python3.13.lib\" CACHE FILEPATH \"\" FORCE)`nendif()' " ^
